...
package com.futurescale.dungeonjoe.view.mediator
{
    ...
    public class LocationMediator extends Mediator
    {
		...
		{
			//location.addEventListener( MouseEvent.CLICK, forceCapturedByWyverns );	
		}
		
		private function forceCapturedByWyverns( event:MouseEvent ):void
		{
			sendNotification( StateMachine.ACTION, null, FSMActions.CAPTURED );			
		}
