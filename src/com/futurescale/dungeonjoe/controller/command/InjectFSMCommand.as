	...
	public class InjectFSMCommand extends SimpleCommand
	{
		override public function execute ( note:INotification ) : void
		{
			...
			<fsm initial={FSMStates.WELCOMING}>
				...
				<!-- WELCOMING -->
				<state name={FSMStates.WELCOMING} 			changed={FSMAnnounce.CHANGED_WELCOMING}
				...
				<!-- SHOWING SCORE -->
				<state name={FSMStates.SHOWING_SCORE}		changed={FSMAnnounce.CHANGED_SHOWING_SCORE}
				...
				<!-- PREPARING LEVEL -->
				<state name={FSMStates.PREPARING_LEVEL} 	changed={FSMAnnounce.CHANGED_PREPARING_LEVEL}
				...
				<!-- MOVING CHARACTER -->
				<state name={FSMStates.MOVING_CHARACTER}	changed={FSMAnnounce.CHANGED_MOVING_CHARACTER}>
				...
				<!-- WAITING IN ROOM -->
				<state name={FSMStates.WAITING_IN_ROOM}		changed={FSMAnnounce.CHANGED_WAITING_IN_ROOM}>
				...
				<!-- WAITING IN PIT -->
				<state name={FSMStates.WAITING_IN_PIT}		changed={FSMAnnounce.CHANGED_WAITING_IN_PIT}>
				...
				<!-- BEING CARRIED -->
				<state name={FSMStates.BEING_CARRIED}		changed={FSMAnnounce.CHANGED_BEING_CARRIED}>
				...
				<!-- USING ITEM -->
				<state name={FSMStates.USING_ITEM}			changed={FSMAnnounce.CHANGED_USING_ITEM}
				...
				<!-- TAKING ITEM -->
				<state name={FSMStates.TAKING_ITEM}			changed={FSMAnnounce.CHANGED_TAKING_ITEM}>
				...
				<!-- QUITTING -->
				<state name={FSMStates.QUITTING} 			changed={FSMAnnounce.CHANGED_QUITTING}/>
