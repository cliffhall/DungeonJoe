	...
	public class InjectFSMCommand extends SimpleCommand
	{
		override public function execute ( note:INotification ) : void
		{
			...
			<fsm initial={FSMStates.WELCOMING}>
				...
				<!-- PREPARING LEVEL -->
				<state
					name={FSMStates.PREPARING_LEVEL}
				...
				<!-- MOVING CHARACTER -->
				<state
					name={FSMStates.MOVING_CHARACTER}
				...
				<!-- WAITING IN ROOM -->
				<state
					name={FSMStates.WAITING_IN_ROOM}
